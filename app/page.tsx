...
export default function Home() {
  ...
  const handleLike = (postId: string) => {
    ...
    const currentCount = likesCount[postId] !== undefined ? likesCount[postId] : post.likes;
      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-6 py-6">
          ...
          <nav className="flex flex-col gap-1">
            ...
            <button className="flex items-center gap-4 p-2.5 rounded-xl hover:bg-zinc-200/50 dark:hover:bg-zinc-800/40 text-sm font-medium w-full text-left transition">
              <span className="text-indigo-500">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
              </span>
              Groups
            </button>
            <button className="flex items-center gap-4 p-2.5 rounded-xl hover:bg-zinc-200/50 dark:hover:bg-zinc-800/40 text-sm font-medium w-full text-left transition">
            ...
            <button className="flex items-center gap-4 p-2.5 rounded-xl hover:bg-zinc-200/50 dark:hover:bg-zinc-800/40 text-sm font-medium w-full text-left transition">
              <span className="text-amber-500">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2zm0 15l-5-2.18L7 18V5h10v13z" /></svg>
              </span>
              Saved
            </button>
          </nav>
        ...
        <main className="col-span-1 md:col-span-2 flex flex-col gap-6">
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide snap-x">
            {[
              { name: "John Doe", avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=John" },
              { name: "Alice Green", avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=Alice" },
              { name: "Bob Miller", avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=Bob" },
              { name: "Emma Watson", avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=Emma" },
              { name: "David Beck", avatar: "https://api.dicebear.com/7.x/adventurer/svg?seed=David" }
            ].map((story, i) => (
              <div
                key={i}
              ...
              >
                <div className="absolute top-2 left-2 z-10 w-8 h-8 rounded-full border-2 border-blue-500 overflow-hidden bg-white">
                  <Image src={story.avatar} alt="Avatar" width={32} height={32} />
                </div>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl p-4 shadow-sm border border-zinc-200/80 dark:border-zinc-800 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between text-zinc-600 dark:text-zinc-400 font-semibold text-xs md:text-sm">
              <button className="flex items-center justify-center gap-2 py-1.5 px-3 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition">
                <span className="text-red-500">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M21 6H3c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-10 7H8v3H6v-3H3v-2h3V8h2v3h3v2z" /></svg>
                </span>
                Live Video
              </button>
              <button className="flex items-center justify-center gap-2 py-1.5 px-3 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition">
                ...
                >
                  ...
                  <div className="flex items-center justify-between p-4">
                    <div className="flex items-center gap-3">
                      ...
                      >
                        <Image src={post.user.avatar} alt="User avatar" width={40} height={40} />
                      </a>
                  ...
                  <div className="w-full relative bg-zinc-100 dark:bg-zinc-950 flex items-center justify-center">
                    {post.type === "video" ? (
                      <PostVideo src={post.mediaUrl} poster={post.thumbnailUrl} />
                    ) : (
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3 items-center hover:bg-zinc-200/50 dark:hover:bg-zinc-800/40 p-1.5 rounded-xl cursor-pointer transition">
              <div className="w-20 h-12 relative rounded-lg overflow-hidden bg-zinc-200 dark:bg-zinc-800 shrink-0">
                <Image
                  src="https://images.pexels.com/photos/161963/chicago-illinois-skyline-skyscraper-161963.jpeg?auto=compress&cs=tinysrgb&w=150"
                  alt="Sponsor ad"
                  fill
                  className="object-cover"
                />
              ...
              <div className="flex flex-col gap-0.5">
                <span className="font-semibold text-xs leading-none">Travel Chicago</span>
                <span className="text-[10px] text-zinc-500 leading-none">chicago-trips.com</span>
              </div>
            </div>
          </div>
            ...
            {[
              ...
              >
                <div className="relative w-8 h-8 rounded-full overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-white">
                  <Image src={contact.avatar} alt="Avatar" width={32} height={32} />
